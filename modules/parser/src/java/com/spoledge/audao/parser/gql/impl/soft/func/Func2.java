 ...
 */
public abstract class Func2 extends Func {
    ...
    protected Object getFunctionValueImpl( List<Object> args ) {
        return getFunctionValue( args.get( 0 ), args.get( 1 ));
    }


    protected void checkNumOfParams( List<Object> args ) {
        checkNumOfParams( 2, args );
    }


    protected abstract Object getFunctionValue( Object arg1, Object arg2 );
