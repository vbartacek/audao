 ...
 */
public abstract class Func1 extends Func {
    ...
    protected Object getFunctionValueImpl( List<Object> args ) {
        return getFunctionValue( args.get( 0 ));
    }


    protected void checkNumOfParams( List<Object> args ) {
        checkNumOfParams( 1, args );
    }


    protected abstract Object getFunctionValue( Object arg );
